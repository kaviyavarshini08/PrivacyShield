...
def pytest_runtest_makereport(item, call):
    ...
    if rep.when == "call":
        ...
        # Identify Category manually for mock report overrides if any
        test_type = "E2E Testing"
        if "test_auth" in test_name:
            test_type = "Validation Testing"
        elif "test_dashboard" in test_name:
            test_type = "UI/UX Testing"
        elif "test_document" in test_name:
            test_type = "Functional Testing"
        elif "test_compliance" in test_name:
